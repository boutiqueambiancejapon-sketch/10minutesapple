      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              <span style={{ fontFamily: 'var(--next-font-display), system-ui, sans-serif', fontWeight: 800, fontSize: '18px', color: 'var(--text-primary)', letterSpacing: '-0.03em' }}>10min</span>
              <span style={{ color: 'var(--accent-1)', fontWeight: 800, fontSize: '18px' }}>·</span>
              <span style={{ fontFamily: 'var(--next-font-display), system-ui, sans-serif', fontWeight: 400, fontSize: '18px', color: 'var(--text-primary)', letterSpacing: '-0.02em' }}>Apple</span>
            </Link>
