...
description: "Web dev, mobile, backend, DevOps : quel MacBook choisir selon ton profil de développeur ? Air M5, Pro M5 Pro ou M5 Max — specs, prix et verdict."
...
aiSummary:
  - "MacBook Air M5 16 Go = parfait pour le web dev (React, Vue, Next.js) et le backend léger (Node, Python, Go)."
  - "MacBook Pro M5 Pro = nécessaire pour Xcode (iOS/macOS dev), Docker lourd et les VMs."
  - "256 Go de stockage est impossible pour un dev — Xcode seul pèse 30 Go. 512 Go minimum, 1 To recommandé."
faq:
  - q: "Le MacBook Air M5 suffit-il pour le développement web ?"
  ...
  - q: "Faut-il un MacBook Pro pour développer avec Xcode ?"
    a: "Pour les petites apps SwiftUI, le MacBook Air M5 tient. Mais dès que tu compiles un projet iOS moyen avec des pods et des assets, le ventilateur du Pro fait la différence — pas de throttling thermique, builds plus rapides et constants."
  ...
  - q: "Le MacBook supporte-t-il le multi-écran ?"
    a: "Le MacBook Air M5 supporte 2 écrans externes (dont un via Thunderbolt). Les MacBook Pro M5 Pro et M5 Max supportent jusqu'à 3 écrans externes. Pour un setup développeur avec 2 écrans + le MacBook, le Pro est recommandé."
  - q: "Faut-il le M5 Max pour le développement ?"
    a: "Seulement si tu fais du ML intensif, de la compilation de gros projets C++/Rust, ou que tu tournes plusieurs VMs simultanément. Pour 95% des développeurs, le M5 Pro est le plafond de ce qui est utile."
  - q: "Quel MacBook pour le développement Android ?"
    a: "Le MacBook Air M5 16 Go gère Android Studio correctement, mais l'émulateur Android est gourmand. 24 Go de RAM et un Pro sont préférables si tu utilises l'émulateur fréquemment. L'émulateur ARM natif sur Apple Silicon est bien plus rapide que l'ancien x86."
stickyCta:
  - label: "MacBook Air M5 16 Go — voir le prix"
...
<StatRow>
  <StatCard value="1 099 €" label="Air M5 — web dev" accent="1" />
  <StatCard value="2 499 €" label="Pro M5 Pro — Xcode / Docker" accent="2" />
  <StatCard value="4 099 €" label="Pro M5 Max — ML / VMs" accent="3" />
</StatRow>
...
<CompareBarGroup leftName="Air M5" rightName="Pro M5 Pro">
  <CompareBar label="Web front-end" left="95" right="95" leftName="Air M5" rightName="Pro M5 Pro" />
  <CompareBar label="Backend Node/Python/Go" left="90" right="95" leftName="Air M5" rightName="Pro M5 Pro" />
  <CompareBar label="iOS dev (Xcode)" left="65" right="92" leftName="Air M5" rightName="Pro M5 Pro" />
  <CompareBar label="Docker (3+ conteneurs)" left="60" right="90" leftName="Air M5" rightName="Pro M5 Pro" />
  <CompareBar label="DevOps / VMs" left="45" right="88" leftName="Air M5" rightName="Pro M5 Pro" />
  <CompareBar label="Rapport qualité-prix" left="95" right="75" leftName="Air M5" rightName="Pro M5 Pro" />
</CompareBarGroup>
...
<Verdict>Pour le développement web et backend, le MacBook Air M5 16 Go / 512 Go est le choix rationnel — il fait tout ce qu'il faut à 1 399 €. Dès que tu touches à Xcode, Docker lourd ou aux VMs, passe au MacBook Pro M5 Pro 24 Go. Le M5 Max est réservé au ML intensif et à la compilation de très gros projets. Dans tous les cas, 512 Go de stockage minimum — 256 Go est un piège.</Verdict>
